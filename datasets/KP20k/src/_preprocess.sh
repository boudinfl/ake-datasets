...
echo "Training dataset will not be processed with CoreNLP as it is rarely used and takes approx. 1 hour. To process it please run \`datasets/KP20k/_preprocess_train.sh\`"

pretreat "${root}/kp20k/kp20k.test.jsonl" "test" "author"
pretreat "${root}/kp20k/kp20k.valid.jsonl" "valid" "author"
